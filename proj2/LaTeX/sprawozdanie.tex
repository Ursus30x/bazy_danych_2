...
Wykresy na rysunkach~\ref{fig:phases_4} i~\ref{fig:phases_16} przedstawiają zależność liczby faz scalania od liczby rekordów dla różnych wielkości buforów. Obserwacje te potwierdzają teoretyczną złożoność algorytmu:
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.75\linewidth]{../charts/phases_vs_records_buffer_4.png}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.75\linewidth]{../charts/phases_vs_records_buffer_16.png}
